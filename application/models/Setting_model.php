...
class Setting_model extends MY_Model {
    ...
    public function getSetting() {  
        ...
        $this->db->select('sch_settings.id,sch_settings.base_url,sch_settings.folder_path,
          sch_settings.attendence_type,sch_settings.lang_id,sch_settings.is_rtl,
          sch_settings.fee_due_days,sch_settings.staff_notification_email,sch_settings.class_teacher,
          sch_settings.cron_secret_key,sch_settings.timezone,sch_settings.online_admission_application_form,
          sch_settings.name,sch_settings.email,sch_settings.biometric,
          sch_settings.biometric_device,sch_settings.phone,sch_settings.adm_prefix,
